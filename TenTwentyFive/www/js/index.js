...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var homeButton = Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes([ "ui labeled icon button" ]), Halogen_HTML_Properties.href("#/") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes([ "left chevron icon" ]) ])([  ]), Halogen_HTML_Core.text("Home") ]);
  exports["homeButton"] = homeButton;
})(PS["Components.HomeButton"] = PS["Components.HomeButton"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {// module DOM.WebStorage.Game
...
})(PS["DOM.WebStorage.Game"] = PS["DOM.WebStorage.Game"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Global = PS["Global"];
  var $$Math = PS["Math"];
  var Math_Statistics_Types = PS["Math.Statistics.Types"];
  var Partial_Unsafe = PS["Partial.Unsafe"];
  var Prelude = PS["Prelude"];                                                                
  ...
  var maximum = Data_Foldable.foldl(Data_Foldable.foldableArray)($$Math.max)(-Global.infinity);
  exports["maximum"] = maximum;
  exports["mean"] = mean;
})(PS["Math.Statistics.Unsafe"] = PS["Math.Statistics.Unsafe"] || {});
(function(exports) {
    "use strict";
  var Control_Apply = PS["Control.Apply"];
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Data_Unit = PS["Data.Unit"];
  var Math_Statistics_Unsafe = PS["Math.Statistics.Unsafe"];
  var Prelude = PS["Prelude"];        
  var Round = (function () {
  ...
  var GameSave = (function () {
      function GameSave(value0) {
          this.value0 = value0;
      };
      GameSave.create = function (value0) {
          return new GameSave(value0);
      };
      return GameSave;
  })();
  var initialGame = [ new Round({
      results: Data_Array.replicate(6)(false), 
      distance: 10
  }), new Round({
      results: Data_Array.replicate(6)(false), 
      distance: 15
  ...
  var getDistance = function (v) {
      return v.value0.distance;
  };
  var grouped = (function () {
      var equalRs = function (v) {
          return function (v1) {
              return v.value0.distance === v1.value0.distance;
          };
      };
      return function ($69) {
          return Data_Array.groupBy(equalRs)(Data_Array.sortWith(Data_Ord.ordInt)(getDistance)(Data_Array.concatMap(function (v) {
              return v.value0.game;
          })($69)));
      };
  })();                                                                      
  ...
  var getMadeBaskets = function (v) {
      return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Functor.functorArray)(boolToInt)(v.value0.results));
  };
  var madeShotScore = function (v) {
      return v.value0.distance * getMadeBaskets(new Round(v.value0)) | 0;
  };
  var madeAllScore = function (v) {
      return v.value0.distance * boolToInt(Data_Foldable.and(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(v.value0.results)) | 0;
  };
  var madeFirstLastScore = function (v) {
      var multiplier = (function () {
          if (v.value0.distance < 30) {
              return 5;
          };
          if (Data_Boolean.otherwise) {
              return 10;
          };
          throw new Error("Failed pattern match at TenTwentyFive.Types line 85, column 5 - line 89, column 1: " + [  ]);
      })();
      var madeScore = function (f) {
          return multiplier * boolToInt(Data_Maybe.fromMaybe(false)(f(v.value0.results))) | 0;
      };
      return madeScore(Data_Array.head) + madeScore(Data_Array.last) | 0;
  };
  var scoreRound = function (r) {
      return (madeShotScore(r) + madeAllScore(r) | 0) + madeFirstLastScore(r) | 0;
  };
  var scoreGame = function ($70) {
      return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Functor.functorArray)(scoreRound)($70));
  };
  var scores = Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return Data_Int.toNumber(scoreGame(v.value0.game));
  });
  var highestScore = function (v) {
      if (v.length === 0) {
          return 0.0;
      };
      return Math_Statistics_Unsafe.maximum(scores(v));
  };
  var averageScore = function (v) {
      if (v.length === 0) {
          return 0.0;
      };
      return Math_Statistics_Unsafe.mean(scores(v));
  };
  var averageRoundPercents = function (gs) {
      var sumIt = function (f) {
          return function ($71) {
              return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringNumber)(Data_Functor.map(Data_Functor.functorArray)(function ($72) {
                  return Data_Int.toNumber(f($72));
              })(Data_NonEmpty.fromNonEmpty(function (a) {
                  return function (fa) {
                      return Data_Array.cons(a)(fa);
                  };
              })($71)));
          };
      };
      var totalRoundShots = sumIt(function (v) {
          return Data_Array.length(v.value0.results);
      });
      var roundAvg = sumIt(function (v) {
          return Data_Array.length(Data_Array.filter(Data_Eq.eq(Data_Eq.eqBoolean)(true))(v.value0.results));
      });
      var mkPoint = function (g) {
          return {
              distance: getDistance(Data_NonEmpty.head(g)), 
              average: roundAvg(g) / totalRoundShots(g)
          };
      };
      return Data_Functor.map(Data_Functor.functorArray)(mkPoint)(grouped(gs));
  };
  exports["GameSave"] = GameSave;
  exports["Round"] = Round;
  exports["averageRoundPercents"] = averageRoundPercents;
  exports["averageScore"] = averageScore;
  exports["boolToInt"] = boolToInt;
  exports["getDistance"] = getDistance;
  exports["getMadeBaskets"] = getMadeBaskets;
  exports["grouped"] = grouped;
  exports["highestScore"] = highestScore;
  exports["initialGame"] = initialGame;
  exports["madeAllScore"] = madeAllScore;
  exports["madeFirstLastScore"] = madeFirstLastScore;
  exports["madeShotScore"] = madeShotScore;
  exports["scoreGame"] = scoreGame;
  exports["scoreRound"] = scoreRound;
  exports["scores"] = scores;
})(PS["TenTwentyFive.Types"] = PS["TenTwentyFive.Types"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["DOM.WebStorage.Game"];
  var Control_Coroutine = PS["Control.Coroutine"];
  ...
  var Data_Function = PS["Data.Function"];
  var Prelude = PS["Prelude"];
  var TenTwentyFive_Types = PS["TenTwentyFive.Types"];        
  var savedGamesProducer = Control_Coroutine_Aff.produce(function (emit) {
      return $foreign.savedGamesChange(function (r) {
          return emit(Data_Either.Left.create(r));
      });
  });
  exports["savedGamesProducer"] = savedGamesProducer;
  exports["deleteSavedGames"] = $foreign.deleteSavedGames;
  exports["saveGame"] = $foreign.saveGame;
})(PS["DOM.WebStorage.Game"] = PS["DOM.WebStorage.Game"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
...
(function(exports) {
  ...
  var homeSlash = Routing_Match_Class.lit(Routing_Match.matchMatchClass)("");
  var playGame = Data_Functor.voidRight(Routing_Match.matchFunctor)(PlayGame.value)(Control_Apply.applySecond(Routing_Match.matchApply)(homeSlash)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("playGame")));
  var stats = Data_Functor.voidRight(Routing_Match.matchFunctor)(Stats.value)(Control_Apply.applySecond(Routing_Match.matchApply)(homeSlash)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("stats")));
  var home = Data_Functor.voidRight(Routing_Match.matchFunctor)(Home.value)(homeSlash);
  var about = Data_Functor.voidRight(Routing_Match.matchFunctor)(About.value)(Control_Apply.applySecond(Routing_Match.matchApply)(homeSlash)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("about")));
  var routing = Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(playGame)(stats))(about))(home);
  var routeProducer = Control_Coroutine_Aff.produce(function (emit) {
      return Routing.matches(routing)(function (v) {
          return function (r) {
              return emit(new Data_Either.Left(r));
          };
      });
  });
  exports["Home"] = Home;
  ...
  exports["about"] = about;
  exports["home"] = home;
  exports["homeSlash"] = homeSlash;
  exports["playGame"] = playGame;
  exports["routeProducer"] = routeProducer;
...
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Components_HomeButton = PS["Components.HomeButton"];
  var Control_Applicative = PS["Control.Applicative"];
  var Data_Function = PS["Data.Function"];
  var Data_Maybe = PS["Data.Maybe"];
  var Data_Unit = PS["Data.Unit"];
  ...
  var ui = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Components_HomeButton.homeButton, Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui container" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "ui centered header" ]) ])([ Halogen_HTML_Core.text("About") ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("What is 1025?") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("1025 is a skills-based program designed to improve your disc golf putt and enhance competitive play.  A complete round consists of 36 putts measured from 10\u2019 to 35\u2019, tiered in 5\u2019 intervals.  A perfect round will result in a score of 1025.") ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("How Do You Play 1025?") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Measure and mark the putting distances from the basket.  Throw 6 putts from each tier.  In order to account for variances in wind condition, lighting, and ground slope, no more than 2 putts may be thrown from a single location.  It is suggested that you set up a triangle for each tier and throw 2 putts from each location.") ]) ]) ]);
      };
      var $$eval = function (v) {
  ...
  exports["ui"] = ui;
})(PS["Routes.About"] = PS["Routes.About"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Data_Function = PS["Data.Function"];
...
(function(exports) {
  ...
  var RoundChange = (function () {
      function RoundChange(value0) {
          this.value0 = value0;
      };
      RoundChange.create = function (value0) {
          return new RoundChange(value0);
      };
      return RoundChange;
  })();
  var ui = function (r) {
      var toss = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(v.value1), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input_(Toggle.create(v.value0))), Halogen_HTML_Properties.classes([ "ui checkbox round" ]) ]) ]);
      };
      var render = function (v) {
      ...
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var newResults = Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction))(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(v1.value0.results);
              var newRound = new TenTwentyFive_Types.Round({
                  results: newResults, 
                  distance: v1.value0.distance
              });
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(newRound))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new RoundChange(newRound)))(function () {
      ...
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](r), 
          render: render, 
          "eval": $$eval, 
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  };
  exports["RoundChange"] = RoundChange;
...
(function(exports) {
  ...
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  var DOM = PS["DOM"];
  var DOM_WebStorage_Game = PS["DOM.WebStorage.Game"];
  var Data_Array = PS["Data.Array"];
  var Data_Function = PS["Data.Function"];
  var Data_Functor = PS["Data.Functor"];
  var Data_Lens_Index = PS["Data.Lens.Index"];
  ...
  var HandleRound = (function () {
      function HandleRound(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      HandleRound.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new HandleRound(value0, value1, value2);
              };
          };
      };
      return HandleRound;
  ...
  var GameSaved = (function () {
      function GameSaved(value0) {
          this.value0 = value0;
      };
      GameSaved.create = function (value0) {
          return new GameSaved(value0);
      };
      return GameSaved;
  })();
  var ui = (function () {
      var render = function (state) {
          var totalScore = Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "ui row centered header" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(TenTwentyFive_Types.scoreGame(state))) ]);
          var roundSlot = function (v) {
              return Halogen_HTML.slot(v.value0)(Round.ui(v.value1))(Data_Unit.unit)(Halogen_HTML_Events.input(HandleRound.create(v.value0)));
          };
          var roundRows = Data_Functor.map(Data_Functor.functorArray)(roundSlot)(Data_Array.zip(Data_Array.range(0)(Data_Array.length(state)))(state));
          var divider = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui divider" ]) ])([  ]);
          var buttonRow = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "row" ]) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "ui primary fluid button" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Save.create)) ])([ Halogen_HTML_Core.text("Save") ]) ]);
          var blankCol = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([  ]);
          return Halogen_HTML_Elements.div_([ Components_HomeButton.homeButton, Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui container" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "ui centered header" ]) ])([ Halogen_HTML_Core.text("New Game") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui eight column grid" ]) ])(Data_Array.snoc(Data_Array.snoc(Data_Array.snoc(roundRows)(divider))(totalScore))(buttonRow)) ]) ]);
      };
      var $$eval = function (v) {
          if (v instanceof HandleRound) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Lens_Setter.set(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction))(v.value1.value0)(v1)))(function () {
          ...
          if (v instanceof Save) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Now.nowDateTime))(function (v2) {
                      var gs = new TenTwentyFive_Types.GameSave({
                          playedOn: v2, 
                          game: v1
                      });
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_WebStorage_Game.saveGame(gs)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new GameSaved(gs)))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
                      });
                  });
          ...
          throw new Error("Failed pattern match at Routes.PlayGame line 72, column 5 - line 72, column 105: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordInt)({
          initialState: Data_Function["const"](TenTwentyFive_Types.initialGame), 
          render: render, 
          "eval": $$eval, 
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  })();
  exports["GameSaved"] = GameSaved;
  exports["HandleRound"] = HandleRound;
  exports["Save"] = Save;
  exports["ui"] = ui;
})(PS["Routes.PlayGame"] = PS["Routes.PlayGame"] || {});
(function(exports) {
    "use strict";
  var Components_HomeButton = PS["Components.HomeButton"];
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var ClearSavedGames = (function () {
      function ClearSavedGames(value0) {
          this.value0 = value0;
      };
      ClearSavedGames.create = function (value0) {
          return new ClearSavedGames(value0);
      };
      return ClearSavedGames;
  })();
  var ui = (function () {
      var stat = function (t) {
          return function (v) {
              return function (l) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_HTML_Core.ClassName("ui " + (t + " statistic")) ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "value" ]) ])([ Halogen_HTML_Core.text(v) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "label" ]) ])([ Halogen_HTML_Core.text(l) ]) ]);
              };
          };
      };
      var percent = function (a) {
          return Data_Show.show(Data_Show.showInt)(Data_Int.round(a * 100.0)) + "%";
      };
      var roundPercentRow = function (v) {
          return Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.classes([ "collapsing" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v.distance) + "'") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.classes([ "collapsing" ]) ])([ Halogen_HTML_Core.text(percent(v.average)) ]) ]);
      };
      var roundPercentTable = function (rps) {
          return Halogen_HTML_Elements.table([ Halogen_HTML_Properties.classes([ "ui very basic celled table" ]) ])([ Halogen_HTML_Elements.thead_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td([ Halogen_HTML_Properties.classes([ "collapsing" ]) ])([ Halogen_HTML_Core.text("Distance") ]), Halogen_HTML_Elements.td([ Halogen_HTML_Properties.classes([ "collapsing" ]) ])([ Halogen_HTML_Core.text("Make %") ]) ]) ]), Halogen_HTML_Elements.tbody_(Data_Functor.map(Data_Functor.functorArray)(roundPercentRow)(rps)) ]);
      };
      var render = function (gs) {
          return Halogen_HTML_Elements.div_([ Components_HomeButton.homeButton, Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui container" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "ui centered header" ]) ])([ Halogen_HTML_Core.text("Stats") ]), stat("small")(Data_Show.show(Data_Show.showInt)(Data_Array.length(gs)))("Games Played"), stat("small")(Data_Show.show(Data_Show.showInt)(Data_Int.round(TenTwentyFive_Types.averageScore(gs))))("Avg Score"), stat("small")(Data_Show.show(Data_Show.showInt)(Data_Int.round(TenTwentyFive_Types.highestScore(gs))))("Highest Score"), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui divider" ]) ])([  ]), Halogen_HTML_Elements.div_([ roundPercentTable(TenTwentyFive_Types.averageRoundPercents(gs)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "ui red fluid button" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ClearSavedGames.create)) ])([ Halogen_HTML_Core.text("Delete Stats") ]) ]) ]);
      };
      var $$eval = function (v) {
          ...
          if (v instanceof ClearSavedGames) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_WebStorage_Game.deleteSavedGames))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Routes.Stats line 87, column 7 - line 87, column 81: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
  ...
  exports["ClearSavedGames"] = ClearSavedGames;
  exports["ui"] = ui;
})(PS["Routes.Stats"] = PS["Routes.Stats"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Routes_About = PS["Routes.About"];
  var Routes_Home = PS["Routes.Home"];
  var Routes_PlayGame = PS["Routes.PlayGame"];
  var Routes_Stats = PS["Routes.Stats"];
  var TenTwentyFive_Types = PS["TenTwentyFive.Types"];        
  var Goto = (function () {
  ...
  var HandlePlayGame = (function () {
      function HandlePlayGame(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandlePlayGame.create = function (value0) {
          return function (value1) {
              return new HandlePlayGame(value0, value1);
          };
      };
      return HandlePlayGame;
  })();
  var SetHistory = (function () {
      function SetHistory(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetHistory.create = function (value0) {
          return function (value1) {
              return new SetHistory(value0, value1);
          };
      };
      return SetHistory;
  })();
  ...
  var ui = (function () {
      var render = function (v) {
          if (v.currentPage instanceof Routes.Home) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Routes_Home.ui)(Data_Unit.unit)(Data_Void.absurd) ]);
          };
          if (v.currentPage instanceof Routes.PlayGame) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Routes_PlayGame.ui)(Data_Unit.unit)(Halogen_HTML_Events.input(HandlePlayGame.create)) ]);
          };
          if (v.currentPage instanceof Routes.Stats) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Routes_Stats.ui)(v.history)(Data_Void.absurd) ]);
          };
          if (v.currentPage instanceof Routes.About) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp4)(Data_Unit.unit)(Routes_About.ui)(Data_Unit.unit)(Data_Void.absurd) ]);
          };
          throw new Error("Failed pattern match at Page line 49, column 5 - line 49, column 98: " + [ v.constructor.name ]);
      };
      var $$eval = function (v) {
          if (v instanceof Goto) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $13.currentPage = v.value0;
                  return $13;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof HandlePlayGame) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new RouteTo("/stats")))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof SetHistory) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $21 = {};
                  for (var $22 in v1) {
          ...
          throw new Error("Failed pattern match at Page line 62, column 5 - line 62, column 109: " + [ v.constructor.name ]);
      };
  ...
  var savedGamesConsumer = function (q) {
      return Control_Coroutine.consumer(Control_Monad_Aff.monadAff)(function (games) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(q(Halogen_Query.action(SetHistory.create(games))))(function (v) {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
          });
      });
  };
  var routeConsumer = function (q) {
      return Control_Coroutine.consumer(Control_Monad_Aff.monadAff)(function (event) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(q(Halogen_Query.action(Goto.create(event))))(function (v) {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
          });
      });
  };
  ...
  exports["Goto"] = Goto;
  exports["HandlePlayGame"] = HandlePlayGame;
  exports["SetHistory"] = SetHistory;
  exports["routeConsumer"] = routeConsumer;
  exports["savedGamesConsumer"] = savedGamesConsumer;
  exports["ui"] = ui;
})(PS["Page"] = PS["Page"] || {});
(function(exports) {// module Routing.Hash
...
(function(exports) {
  ...
  var pageMsgConsumer = Control_Coroutine.consumer(Control_Monad_Aff.monadAff)(function (event) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Routing_Hash.setHash(event.value0)))(function () {
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Maybe.Nothing.value);
      });
  });
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Page.ui)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.forkAff(Control_Coroutine.runProcess(Control_Monad_Aff.monadRecAff)(Control_Coroutine.connect(Control_Monad_Aff.monadRecAff)(Control_Monad_Aff.parallelParAff)(Routes.routeProducer)(Page.routeConsumer(v1.query)))))(function (v2) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.forkAff(Control_Coroutine.runProcess(Control_Monad_Aff.monadRecAff)(Control_Coroutine.connect(Control_Monad_Aff.monadRecAff)(Control_Monad_Aff.parallelParAff)(DOM_WebStorage_Game.savedGamesProducer)(Page.savedGamesConsumer(v1.query)))))(function (v3) {
                  return v1.subscribe(pageMsgConsumer);
              });
          });
      });
  }));
  exports["main"] = main;
  exports["pageMsgConsumer"] = pageMsgConsumer;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
