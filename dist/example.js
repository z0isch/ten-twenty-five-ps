...
(function(exports) {
  ...
  var round = function (r) {
      var toss = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Properties.checked(v.value1), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input_(Toggle.create(v.value0))), Halogen_HTML_Properties.classes([ "ui checkbox" ]) ]) ]);
      };
      var render = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "row" ]) ])(Data_Array.concat([ Data_Functor.map(Data_Functor.functorArray)(toss)(Data_Array.zip(Data_Array.range(0)(Data_Array.length(v.results)))(v.results)), [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(Types.scoreRound(v))) ]) ] ]));
      };
      var $$eval = function (v) {
...
(function(exports) {
  ...
  var game = (function () {
      ...
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui container" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui seven column grid" ]) ])(Data_Array.concat([ Data_Functor.map(Data_Functor.functorArray)(roundSlot)(Data_Array.zip(Data_Array.range(0)(Data_Array.length(state)))(state)), [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "row" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(Types.scoreGame(state))) ]) ]) ] ])) ]);
      };
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
