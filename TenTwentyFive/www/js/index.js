...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var roundLength = function (v) {
      return Data_Array.length(v.results);
  };
  var madeBaskets = function (v) {
      return Data_Array.length(Data_Array.filter(Data_Eq.eq(Data_Eq.eqBoolean)(true))(v.results));
  };
  var initialGame = [ {
  ...
  var getMadeBaskets = function (r) {
      return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Functor.functorArray)(boolToInt)(r.results));
  };
  var madeShotScore = function (r) {
      return r.distance * getMadeBaskets(r) | 0;
  };
  var madeAllScore = function (r) {
      return r.distance * boolToInt(Data_Foldable.and(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(r.results)) | 0;
  };
  var madeFirstLastScore = function (r) {
      var multiplier = (function () {
          ...
          throw new Error("Failed pattern match at TenTwentyFive.Types line 76, column 5 - line 80, column 1: " + [  ]);
      })();
      var madeScore = function (f) {
          return multiplier * boolToInt(Data_Maybe.fromMaybe(false)(f(r.results))) | 0;
      };
  ...
  var scoreGame = function ($24) {
      return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Functor.functorArray)(scoreRound)($24));
  };
  var scores = Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return Data_Int.toNumber(scoreGame(v.game));
  });
  ...
  var averageRoundPercents = function (gs) {
      var totalRoundShots = function ($25) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringNumber)(Data_Functor.map(Data_Functor.functorArray)(function ($26) {
              return Data_Int.toNumber(roundLength($26));
      ...
      var rounds = Data_Array.concat(Data_Functor.map(Data_Functor.functorArray)(function (v) {
          return v.game;
      })(gs));
      var roundAvg = function ($27) {
          return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringNumber)(Data_Functor.map(Data_Functor.functorArray)(function ($28) {
              return Data_Int.toNumber(madeBaskets($28));
          })(Data_NonEmpty.fromNonEmpty(function (a) {
              return function (fa) {
                  return Data_Array.cons(a)(fa);
              };
      ...
      var mkPoint = function (g) {
          return {
              distance: (Data_NonEmpty.head(g)).distance, 
              average: roundAvg(g) / totalRoundShots(g)
          };
      };
      var grouped = Data_Array.groupBy(function (v) {
          return function (v1) {
              return v.distance === v1.distance;
          };
      })(rounds);
      return Data_Functor.map(Data_Functor.functorArray)(mkPoint)(grouped);
  };
  ...
  exports["madeBaskets"] = madeBaskets;
...
(function(exports) {
  ...
  var ui = function (r) {
      ...
      var render = function (r$prime) {
          var tossCols = Data_Functor.map(Data_Functor.functorArray)(toss)(Data_Array.zip(Data_Array.range(0)(Data_Array.length(r$prime.results)))(r$prime.results));
          var scoreCol = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes([ "stat" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(TenTwentyFive_Types.scoreRound(r$prime))) ]) ]);
          var distanceCol = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes([ "stat" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(r$prime.distance) + "'") ]) ]);
      ...
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var newResults = Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction))(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(v1.results);
              var newRound = {
                  results: newResults, 
...
(function(exports) {
  ...
  var ui = (function () {
      ...
      var percent = function (a) {
          return Data_Number_Format.toStringWith(Data_Number_Format.fixed(0))(a * 100.0) + "%";
      };
      var render = function (gs) {
          return Halogen_HTML_Elements.div_([ Components_HomeButton.homeButton, Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui container" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "ui centered header" ]) ])([ Halogen_HTML_Core.text("Stats") ]), stat("small")(Data_Show.show(Data_Show.showInt)(Data_Array.length(gs)))("Games Played"), stat("small")(Data_Show.show(Data_Show.showNumber)(TenTwentyFive_Types.averageScore(gs)))("Avg Score"), stat("small")(Data_Show.show(Data_Show.showNumber)(TenTwentyFive_Types.highestScore(gs)))("Highest Score"), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui divider" ]) ])([  ]), Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return stat("tiny")(percent(v.average))(Data_Show.show(Data_Show.showInt)(v.distance) + "'");
          })(TenTwentyFive_Types.averageRoundPercents(gs))), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "ui red fluid button" ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ClearSavedGames.create)) ])([ Halogen_HTML_Core.text("Delete Stats") ]) ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Routes.Stats line 66, column 7 - line 66, column 81: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
