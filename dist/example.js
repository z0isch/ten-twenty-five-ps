...
(function(exports) {
  ...
  var getMadeBaskets = function (v) {
      return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Functor.functorArray)(boolToInt)(v.results));
  };
  var madeShotScore = function (v) {
      return v.distance * getMadeBaskets(v) | 0;
  };
  var madeAllScore = function (v) {
      return v.distance * boolToInt(Data_Foldable.and(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(v.results)) | 0;
  };
  var madeFirstLastScore = function (v) {
      var multiplier = (function () {
          ...
          throw new Error("Failed pattern match at Types line 37, column 5 - line 41, column 1: " + [  ]);
      })();
      var madeScore = function (f) {
          return multiplier * boolToInt(Data_Maybe.fromMaybe(false)(f(v.results))) | 0;
      };
  ...
  var scoreGame = function ($23) {
      return Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(Data_Functor.map(Data_Functor.functorArray)(scoreRound)($23));
  };
...
(function(exports) {
  ...
  var round = function (r) {
      ...
      var render = function (v) {
          var tossCols = Data_Functor.map(Data_Functor.functorArray)(toss)(Data_Array.zip(Data_Array.range(0)(Data_Array.length(v.results)))(v.results));
          var scoreCol = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "stat" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(Types.scoreRound(v))) ]) ]);
          var distanceCol = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "stat" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v.distance) + "'") ]) ]);
...
(function(exports) {
  ...
  var game = (function () {
      var render = function (state) {
          var totalScore = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "column" ]) ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.classes([ "stat" ]) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(Types.scoreGame(state))) ]) ]);
          var roundSlot = function (v) {
              return Halogen_HTML.slot(v.value0)(Round.round(v.value1))(Data_Unit.unit)(Halogen_HTML_Events.input(HandleRound.create(v.value0)));
          };
          ...
          var totalRow = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "row" ]) ])(Data_Array.snoc(Data_Array.replicate(7)(blankCol))(totalScore));
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui container" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "ui eight column grid" ]) ])(Data_Array.snoc(Data_Array.snoc(roundRows)(divider))(totalRow)) ]);
      };
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
      ...
      return Halogen_Component.parentComponent(Data_Ord.ordInt)({
          initialState: Data_Function["const"](Types.initialGame), 
          render: render, 
          "eval": $$eval, 
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Game.game)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
